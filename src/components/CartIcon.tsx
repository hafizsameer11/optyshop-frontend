...
const CartIcon: React.FC = () => {
    ...
    return (
        <Link
            to="/cart"
            className="relative inline-flex items-center justify-center w-10 h-10 rounded-full border border-blue-400 bg-white/5 hover:bg-blue-500/20 hover:border-blue-300 transition-all duration-200 group"
