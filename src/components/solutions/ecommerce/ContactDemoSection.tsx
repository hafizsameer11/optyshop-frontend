                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 shadow-lg p-4 md:p-6 lg:p-7 w-full">
                            ...
                            <form ref={formRef} onSubmit={handleSubmit} className="space-y-3 md:space-y-3.5">
                                ...
                                <div className="pt-3">
                                    <button
                                        type="submit"
                                        className="w-full px-6 md:px-8 py-2.5 md:py-3 bg-blue-950 text-white font-semibold rounded-lg hover:bg-blue-900 transition-colors duration-300 text-sm md:text-base"
                                    >
